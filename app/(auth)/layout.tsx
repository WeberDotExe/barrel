    ...
    <div className='flex min-h-screen'>
        <section className='bg-brand p-10 hidden w-1/2 items-center justify-center lg:flex xl:w-2/5'>
            <div className='flex max-h-[800px] max-w-[430px] flex-col justify-center space-y-12'>
                ...
                <h1 className='h1'>Handle your files in the best possible way.</h1>
                <p className='body-1'>A place where all your documents can be securely stored.</p>
                </div>
                <Image src="/assets/images/files.png" alt='files' width={324} height={342} className='transition-all hover:rotate-2 hover:scale-105'/>
            </div>
        </section>
